...
CREATE TABLE IF NOT EXISTS repeticao_maxima.parceiros_campanhas (
  ...
  important_message TEXT NOT NULL DEFAULT '',
  use_current_window BOOLEAN NOT NULL DEFAULT FALSE,
...
ALTER TABLE repeticao_maxima.parceiros_campanhas
  ...
  ADD COLUMN IF NOT EXISTS important_message TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS use_current_window BOOLEAN NOT NULL DEFAULT FALSE,
